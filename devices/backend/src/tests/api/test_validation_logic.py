...
class TestActivityLogValidation:
    ...
    def test_activity_types(self):
        ...
        valid_types = ["app_launch", "file_access", "browser", "system", "network", "security"]
    ...
    def test_activity_duration_validation(self):
        ...
        for duration in valid_durations:
            payload = {"deviceid": "device-123", "activity_type": "app_launch", "duration": duration}
...
class TestProcessValidation:
    ...
    def test_process_list_validation(self):
        ...
        process_list = [
            {"deviceid": "device-123", "pid": 1234, "process_name": "chrome", "cpu": 25.5, "memory": 536870912},
            {"deviceid": "device-123", "pid": 5678, "process_name": "firefox", "cpu": 15.2, "memory": 268435456},
        ]
...
class TestHTTPClientLogic:
    ...
    def test_api_url_construction(self):
        ...
        endpoints = ["/devices", "/alerts", "/metrics", "/health"]
...
class TestErrorHandling:
    ...
    def test_empty_payload_handling(self):
        ...
        invalid_payloads = [{}, None, [], "", {"invalid": "data"}]
