...
class TestScreenshotSchemas:
    ...
    def test_screenshot_create(self):
        ...
        user_id = uuid4()
        data = ScreenshotCreate(user_id=user_id, image_path="path/to/screenshot.png")
    ...
    def test_screenshot_out(self):
        ...
        screenshot_id = uuid4()
        now = datetime.now()
        data = ScreenshotOut(id=screenshot_id, user_id=user_id, image_path="path/to/screenshot.png", created_at=now)
...
class TestUserSchemas:
    ...
    def test_user_out(self):
        ...
        user_id = uuid4()
        now = datetime.now()
        data = UserOut(id=user_id, device_id="device-789", name="Jane Doe", created_at=now)
