# 🔧 Database Schema Alignment Issue - SQLAlchemy Models Don't Match Database Schema
...
- Docker images v0.0.5 built and pushed to registry
...
-- Similar issues in device_activity, device_alerts, etc.
```
...
- Update primary key names (e.g., `id` → `device_id`, `metrics_id`, etc.)
...
- `devices/backend/src/app/models/app_activity.py`
...
devices/backend/src/app/models/app_activity.py     (LOW)
```
...
**Priority:** 🔥 Critical - Blocking dashboard functionality  
