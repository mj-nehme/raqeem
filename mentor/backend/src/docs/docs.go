    ...
    "servers": [
        {
            ...
            "variables": {
                ...
                "port": {
                    "default": "30090",
                    "description": "Set this to your mentor backend port (e.g., from .env: MENTOR_BACKEND_PORT)"
                }
            }
        }
    ],
            ...
            "post": {
                ...
                "requestBody": {
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                "$ref": "#/components/schemas/DeviceRemoteCommand"
                            }
                        }
                    }
                },
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/components/schemas/DeviceProcess"
                                }
                            }
                        }
                    }
            ...
            "post": {
                ...
                "requestBody": {
                    ...
                    "content": {
                        "application/json": {
                            "schema": {
                                "$ref": "#/components/schemas/DeviceScreenshot"
                            }
                        }
                    }
                },
